...
export function fetchCoins(
    url = JadexAPIs.BASE + JadexAPIs.COINS_LIST
) {
...
export function fetchTradingPairs(
    url = JadexAPIs.BASE + JadexAPIs.TRADING_PAIRS
) {
...
export function getDepositLimit(
    inputCoin,
    outputCoin,
    url = JadexAPIs.BASE + JadexAPIs.DEPOSIT_LIMIT
) {
    return fetch(
        url +
            "?inputCoinType=" +
...
export function estimateOutput(
    ...
    inputCoin,
    outputCoin,
    url = JadexAPIs.BASE + JadexAPIs.ESTIMATE_OUTPUT
) {
    return fetch(
        url +
            "?inputAmount=" +
...
export function estimateInput(
    ...
    inputCoin,
    outputCoin,
    url = JadexAPIs.BASE + JadexAPIs.ESTIMATE_INPUT
) {
    return fetch(
        url +
            "?outputAmount=" +
...
export function getActiveWallets(
    url = JadexAPIs.BASE + JadexAPIs.ACTIVE_WALLETS
) {
...
export function getDepositAddress({coin, account, stateCallback}) {
    ...
    fetch(JadexAPIs.BASE + "/simple-api/get-last-address", {
        method: "POST",
        headers: new Headers({
