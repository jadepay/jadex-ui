...
class Footer extends React.Component {
    ...
    componentDidMount() {
        ...
        this.downloadLink = "https://jadex.org/#download";
    }
    ...
    checkNewVersionAvailable() {
        if (__ELECTRON__) {
            fetch(
                "https://api.github.com/repos/jadex/jadex-ui/releases/latest"
            )
                .then(res => {
                    return res.json();
                })
    ...
    launchIntroJS() {
        ...
        if (hintData.length == 0) {
            // this.context.router.push("/help/introduction/jadex");
        } else {
            guide
                .introJs()
                .setOptions({
                        ...
                        <div className="grid-block">
                            ...
                            >
                                ...
                                <span style={updateStyles}>
                                    <Translate content="jadex.footer.title" />
