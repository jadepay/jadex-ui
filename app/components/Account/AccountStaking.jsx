...
class VestingBalance extends React.Component {
    _onClaim(claimAll, e) {
        e.preventDefault();
        JadexActions.claimStakingBalance(
    ...
    render() {
        ...
        return (
            <div>
                <h2>
                    <Translate content="jadex.account.id" /> {vb.id}
                </h2>
                ...
                <table className="table key-value-table">
                    <tbody>
                        <tr>
                            <td>
                                <Translate content="jadex.account.staking_amount" />
                            </td>
                            <td>
                                <FormattedAsset
                        ...
                        <tr>
                            <td>
                                <Translate content="jadex.account.remaining" />
                            </td>
                            <td>
                                {daysLeft > 0 ? (
                                    <Translate
                                        days={daysLeft}
                                        content="jadex.account.days"
                                    />
                                ) : (
                                    <Translate
                                        className="green"
                                        content="jadex.account.available"
                                    />
                                )}
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <Translate content="jadex.account.status" />
                            </td>
                            <td style={{textAlign: "right"}}>
                                {available ? (
                                    ...
                                    <Translate content="jadex.account.staking" />
                                )}
                            </td>
                        </tr>
                    </tbody>
                ...
                <div className="content-block small-12">
                    ...
                    <div style={{marginTop: "2rem"}}>
                        {!balances.length ? (
                            <h4>
                                <Translate
                                    content={"jadex.account.no_balances"}
                                />
                            </h4>
                        ) : (
                            balances
