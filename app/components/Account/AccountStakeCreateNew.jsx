...
export class AccountStakingInfo {
    static stakingPeriods = [
        {
            name1: "jadex.account.month_1",
            bonus: "0%",
            name: counterpart.translate("jadex.account.month_1", {
                bonus: "0%"
            }),
            monthName: counterpart.translate(
                "jadex.account.month_1_plural"
            ),
            value: 2678400
        },
        {
            name1: "jadex.account.month_3",
            bonus: "20%",
            name: counterpart.translate("jadex.account.month_3", {
                bonus: "20%"
            }),
            monthName: counterpart.translate(
                "jadex.account.month_3_plural"
            ),
            value: 7776000
        },
        {
            name1: "jadex.account.month_6",
            bonus: "50%",
            name: counterpart.translate("jadex.account.month_6", {
                bonus: "50%"
            }),
            monthName: counterpart.translate(
                "jadex.account.month_6_plural"
            ),
            value: 15552000
        },
        {
            name1: "jadex.account.month_12",
            bonus: "100%",
            name: counterpart.translate("jadex.account.month_12", {
                bonus: "100%"
            }),
            monthName: counterpart.translate(
                "jadex.account.month_12_plural"
            ),
            value: 31536000
        }
    ];
    ...
    render() {
            ...
            >
                ...
                {currentBalance && currentBalance.get("balance") ? (
                    <span>
                        <Translate
                            component="span"
                            content="jadex.account.bco_available"
                        />
                    ...
                    <Translate
                        component="span"
                        content="jadex.account.bco_not_available"
                    />
                )}{" "}
            </span>
        );
        ...
        return (
            <div>
                <Translate
                    component="h2"
                    content="jadex.account.title"
                />
                <Translate
                    component="p"
                    content="jadex.account.staking_text1"
                    with={{percent: "50%"}}
                    unsafe
                />
                <Translate
                    component="p"
                    content="jadex.account.staking_text2"
                    with={{
                        fee,
                        reclaimFee
                    }}
                ...
                <Translate
                    component="p"
                    content="jadex.account.staking_text3"
                    unsafe
                />
                ...
                <div className="grid-block no-margin small-12 medium-6">
                    <Translate
                        component="label"
                        unsafe
                        content="jadex.account.amount_bco"
                    />
                    <AmountSelector
                ...
                <div className="grid-block no-margin small-12 medium-6">
                    ...
                    {amount > 0 ? (
                        ...
                        >
                            ...
                            />
                            {counterpart("jadex.account.understand", {
                                amount,
                    ...
                    <div style={{width: "100%", textAlign: "right"}}>
                        <button
                            ...
                            className="button"
                        >
                            <Translate content="jadex.account.stake_bco" />
                        </button>
                    </div>
                </div>
            </div>
