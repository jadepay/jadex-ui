...
import JadexGateway from "../DepositWithdraw/jadex/JadexGateway";
...
class AccountDepositWithdraw extends React.Component {
    ...
    shouldComponentUpdate(nextProps, nextState) {
        return (
            ...
            !utils.are_equal_shallow(
                nextProps.JadexBackedCoins,
                this.props.JadexBackedCoins
            ) ||
    ...
    render() {
        ...
        let JadexGatewayCoins = this.props.JadexBackedCoins.map(
            coin => {
                return coin;
            }
        );
                ...
                >
                    ...
                    <div className="grid-block vertical medium-horizontal no-margin no-padding">
                        <div className="medium-6 show-for-medium">
                            <h3>
                                <Translate content="jadex.gateway.deposit_or_withdrawal" />
                            </h3>
                            <p>
                                <Translate content="jadex.gateway.deposit_intro" />
                            </p>
                        </div>
                        <div className="medium-5 medium-offset-1">
                            <h3>
                                <Translate content="jadex.gateway.receive_funds" />
                            </h3>
                            <p>
                                <Translate content="jadex.gateway.receive_funds_intro" />
...
export default connect(DepositStoreWrapper, {
    ...
    getProps() {
        return {
            ...
            JadexBackedCoins: GatewayStore.getState().backedCoins.get(
                "JADEX",
                []
            ),
