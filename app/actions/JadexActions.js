...
const API_MARKET_URL = JadexAPIs.BASE + JadexAPIs.MARKETS;
const API_NEWS_URL = "https://jadex.org/news.json";
...
export default alt.createActions(JadexActions);
